...
Visionar Opcion: [Prueba](http://tenminator-votpvbfn.manus.space): (No funcional) 
...
Si deseas realizar otros entrenamientos especificos distintos, les sugerimos personalizar librerias especificas como [TenMiniTorch](http://github.com/yoqer/TenMiniTorch) ; como la base para cualquier otro proyecto; o la General extensa que entrena Gradientes y todas las funciones generalizadas; a la que pueden añadir cualquier Framework especifico de entrenamiento que usen: [TenMinaTorch](http://github.com/yoqer/TenMinaTorch) : la libreria general no personalizada para proposito de funcion de comunicacion y validacion razonal: `TenMINator` 
la que tiene activas ciertas limitaciones instrumentales y puede usarse con la APP simple que pueden ver en este enlace de Version de [Prueba](http://tenminator-votpvbfn.manus.space).
