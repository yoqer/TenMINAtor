...
Si deseas realizar otros entrenamientos especificos distintos, les sugerimos personalizar librerias especificas como [TenMiniTorch](http://github.com/yoqer/TenMiniTorch) ; como la base para cualquier otro proyecto; o la General extensa que entrena Gradientes y todas las funciones generalizadas; a la que pueden añadir cualquier Framework especifico de entrenamiento que usen: [TenMinaTorch](http://github.com/yoqer/TenMinaTorch) : la libreria general no personalizada para funcion de proposito de comunicacion y validacion razonal, como `TenMINator` 
